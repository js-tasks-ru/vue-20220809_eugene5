...
const { default: MeetupAgenda } = require(global.getSolutionPath('components/MeetupAgenda'))
const { default: MeetupAgendaItem } = require(global.getSolutionPath('components/MeetupAgendaItem'))
